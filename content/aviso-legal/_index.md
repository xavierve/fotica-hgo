---
# o2 — Aviso Legal y Política de Privacidad (unificadas, decisión confirmada en docs)
title: "Aviso Legal, Privacidad y Cookies | Ópticas Fausto"
linkTitle: "Aviso Legal"
description: "Información legal, condiciones de uso, política de privacidad y política de cookies del sitio web de Ópticas Fausto, Torre del Mar."
sitemap:
  priority: 0.1
...
El acceso a esta web es gratuito y no requiere registro previo. El envío de datos personales a través del formulario de contacto implica la aceptación expresa de nuestra Política de Privacidad (sección siguiente).
...
Si en algún momento Ópticas Fausto decide activar campañas de publicidad en Google Ads o Meta (Instagram/Facebook Ads) con seguimiento de conversiones, o herramientas de analítica web, esta sección se actualizará para detallar qué cookies se instalan, su finalidad, duración y titular, y se incorporará un aviso de consentimiento previo a la carga de dichas cookies, permitiendo al usuario aceptarlas, rechazarlas o configurarlas de forma granular, conforme a la normativa vigente (RGPD y LSSI-CE).

### Cambios en esta política

Esta política puede modificarse para adaptarse a cambios en el sitio web o a nuevas exigencias legislativas. Cuando se produzcan cambios significativos, se comunicará al usuario en esta misma página.

En resumen: navega tranquilo. Aquí ni te seguimos ni te perfilamos — preferimos [conocerte en persona](/contacto/).
